        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Enterprise-grade multi-agent consensus system for SMS spam
              classification with dynamic reputation management and explainable
              predictions.
            </p>
            ...
            <div className="flex items-center justify-center gap-3 mb-8">
              <div
                className={`w-3 h-3 rounded-full ${systemStatus === "ready" ? "bg-green-500" : systemStatus === "checking" ? "bg-yellow-500" : "bg-red-500"}`}
              />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <div className="text-3xl font-bold text-green-400">
                {stats.trained_agents}/{stats.total_agents}
              </div>
            ...
            >
              ...
              <div className="text-3xl font-bold text-purple-400">
                {stats.consensus_accuracy}%
              </div>
              <div className="text-xs text-gray-500 mt-2">
                On 1,031 SMS messages
              </div>
            </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-400 text-sm">
                Every prediction includes individual agent votes, confidence
                scores, and reasoning. Understand exactly why the system
                classified each message.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 text-sm">
                Dynamic weight adjustment improves accuracy over time.
                Poor-performing agents are automatically downweighted, better
                ones upweighted.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 text-sm">
                Production-grade API with Supabase backend, rate limiting, JWT
                security, comprehensive logging, and audit trails.
              </p>
            </motion.div>
          </div>
        </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-white mb-2">
                    SMS Received → 1,004 Features Extracted
                  </h3>
                  <p className="text-gray-400 text-sm">
                    Messages are preprocessed with TF-IDF vectorization,
                    producing 1,004-dimensional feature vectors
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">
                    Weighted votes combined using dynamic weights. Final
                    decision made with 98.2% accuracy
                  </p>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-16 px-4 border-t border-slate-700 bg-gradient-to-b from-slate-900 to-slate-950">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 mb-8">
            Scroll up and click "Test Predictions" to classify SMS messages, or
            explore the dashboard for advanced analytics.
          </p>
        </div>
      </section>
    </div>

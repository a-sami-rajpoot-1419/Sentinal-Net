  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-400">Overview of all available ML models in the ensemble</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {agents.map((agent) => (
            <div key={agent.name} className="glass p-6 rounded-lg space-y-4">
              <div className="flex items-center justify-between">
                ...
                >
                  {agent.trained ? 'Trained' : 'Not Trained'}
                </span>
              </div>
      ...
      <div className="glass p-6 rounded-lg">
        ...
        <div className="space-y-4 text-sm text-gray-300">
          <p>
            All agents are trained on the same preprocessed dataset with TF-IDF vectorization
            (1000 dimensions) + 4 engineered features (1004 total dimensions).
          </p>
          <p>
            During prediction, all 4 agents vote independently on the class. The RWPV consensus
            engine aggregates votes using dynamic weights based on historical performance.
          </p>
          <p>

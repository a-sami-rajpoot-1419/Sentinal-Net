        ...
        >
          <section className="p-6 bg-slate-800/50 border border-slate-700 rounded-xl">
            ...
            <div className="bg-slate-900/50 p-4 rounded-lg font-mono text-sm space-y-2 mb-4">
              ...
              <div className="text-gray-400">cd sentinel-net</div>
            ...
            <p className="text-sm text-gray-400">
              Backend runs on http://localhost:8000, Frontend on
              http://localhost:3001
            </p>
          </section>
          ...
          <section className="p-6 bg-slate-800/50 border border-slate-700 rounded-xl">
            ...
            <div className="space-y-2 text-sm text-gray-300 font-mono">
              <p>
                <span className="text-blue-300">SUPABASE_URL</span>
                =your-supabase-project-url
              </p>
              <p>
                <span className="text-blue-300">SUPABASE_KEY</span>
                =your-supabase-api-key
              </p>
              <p>
                <span className="text-blue-300">LOG_LEVEL</span>=INFO
              </p>
          ...
          <section className="p-6 bg-slate-800/50 border border-slate-700 rounded-xl">
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li className="flex gap-3">
                ...
                <span>
                  <strong>Backend:</strong> AWS Lambda, Google Cloud Run, or
                  Railway
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-blue-400">•</span>
                <span>
                  <strong>Frontend:</strong> Vercel, Netlify, or any static host
                </span>
              </li>
              <li className="flex gap-3">
                <span className="text-blue-400">•</span>
                <span>
                  <strong>Database:</strong> Managed PostgreSQL (Supabase, RDS)
                </span>
              </li>
            </ul>
          </section>
